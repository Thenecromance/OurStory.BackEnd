        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <!-- <li class="nav-item d-flex align-items-center">
            <router-link :to="{ name: 'Login' }" class="px-0 nav-link font-weight-bold text-white" target="_blank">
              ...
              <span class="d-sm-inline d-none">登陆</span>
            </router-link>
          </li> -->

          <!--logged in -->
          <li class="nav-item dropdown d-flex align-items-center pe-2">
            <a href="#" class="p-0 nav-link text-white" :class="[showProfile ? 'show' : '']" id="dropdownProfileButton"
              data-bs-toggle="dropdown" aria-expanded="false" @click="showProfile = !showProfile" @blur="closeProfile">
              <img src="../../assets/img/team-2.jpg" class="avatar avatar-sm" />
            </a>

            <ul class="px-2 py-3 dropdown-menu dropdown-menu-end sm-n4" :class="showProfile ? 'show' : ''"
