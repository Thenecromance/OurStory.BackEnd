...
//	var cfg zapConfig
//
//	Config.InstanceByName("zapConfig", constants.Yaml).LoadToObject("config", &cfg)
//	/*	levelEncoder, err := CustomLevelEncoder(cfg.EncodeLevel)
//		if err != nil {
...
//				// These would also need custom parsers if they are complex types
